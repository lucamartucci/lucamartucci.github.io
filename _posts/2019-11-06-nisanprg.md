...
**Lemma 3.1** $$\Pr \left[ \lvert\lvert M^2[x_1, h_1(x_1)] -M^2(x_1,x_2)\rvert\rvert \geq \epsilon \right ] \leq \frac{\alpha\beta\cdot d^7}{2^m \epsilon^2}$$
...
With Lemma 2.5, if we want this holds for all triples $(i, p, j)$, a union bound gives us that  
